  ...
  <el-card class="box-card">
    ...
    <div v-for="v in messages" :key="v.id">
      <div v-if="v.user===user_id">
        <div v-if="v.chat_type">
          <el-card v-if="v.id!=''" class="my-chat-bubble" >
            {{ v.id+" "+v.user + " : image"}}
            <img :src="'http://localhost:5000/'+v.message" />
          </el-card>
        </div>
        <div v-else>
          <el-card v-if="v.id!=''" class="my-chat-bubble">
      ...
      <el-row style="margin:20px,0;">
        <el-col :lg="16">
          <el-input v-model="messageText" autosize type="textarea" style="width: 400px">
          </el-input>
          <el-upload
            ref="uploadRef"
            class="upload-demo"
          ...
          <br>
          <el-button  type="success" size="large" @click="sendMessage" :disabled="isdiabled">发送</el-button>
        </el-col>
      </el-row>
    </el-main>
  </el-container>
