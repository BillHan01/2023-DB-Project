<template>
    <el-container>
      ...
      <el-main>
        <el-form :model="userInfo" @submit.prevent="modifyUser">
          <!-- Add form items here for the user and customer information -->
          ...
          <el-button type="primary" @click="startEditing">Edit Categories</el-button>
          <el-form-item label="Category" v-if="editing">
            <el-select v-model="cusInfo.cus_loves" multiple clearable placeholder="Select" filterable allow-create>
                <el-option v-for="item in categories" :key="item" :label="item" :value="item">
                </el-option>
            </el-select>
            </el-form-item>
          <!-- ...other form items for the customer... -->
