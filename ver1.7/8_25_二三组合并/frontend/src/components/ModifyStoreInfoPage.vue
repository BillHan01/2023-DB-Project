<template>
  <el-container>
    ...
    <el-main>
      <el-form :model="userInfo" ref="form" @submit.prevent="modifyUser">
        <!--
        <el-form-item label="Store ID">
          <el-input v-model="userInfo.sto_ID" disabled></el-input>
        </el-form-item>
        -->
    ...
    <el-button @click="searchLocation">搜索地址</el-button> <!-- 新增的确认按钮 -->
