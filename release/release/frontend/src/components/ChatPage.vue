<template>
  ...
  <el-container>
        <el-aside width="350px" style="background-color: #fde2e2;">
          ...
          <div v-for="v in chatlist" :key="v.user">
            <el-menu-item class="chatmember"  v-if="v.user" @click="exchange_chat_member(v.user)" :index=v.user>
                ...
                <el-col :span="10"><img v-if="v.sto_image!=''" style="display:flex; margin-top: 20px;n width: 140px;height: 100px;" :src="'http://124.70.7.210:5000/'+v.message"/></el-col>
                </el-row>
                <el-row>
                  ...
                  <span v-if="v.receive" class="dot"></span>
                   <img v-if="v.sto_image!=''" style="margin-left: 140px;margin-top: -50px;max-width: 70px;max-height: 70px;" :src="'http://124.70.7.210:5000/'+v.message" class="image"/>
                </div>
              <br> -->
              ...
              <div>
                  <img v-if="v.sto_image!=''" style="width: 140px;height: 100px;" :src="'http://124.70.7.210:5000/'+v.sto_image"/>
              </div>
          </div>
            </el-menu-item>
          </div>
        ...
        <el-main style="background-color: #fef0f0;">
        ...
        <div v-if="v.user===user_id">
          ...
          <div v-if="v.chat_type">
            <el-card v-if="v.id!=''" class="my-chat-bubble" >
              ...
              <img :src="'http://124.70.7.210:5000/'+v.message" class="image"/>
            </el-card>
          </div>
          <div v-else>
            <el-card v-if="v.id!=''" class="my-chat-bubble">
  ...
  import { fa } from 'element-plus/es/locale';
    ...
    const address='http://124.70.7.210:5000/api/'
  ...
  .my-chat-bubble {
    background-color:#ffffb3; /* 设置气泡的背景颜色 */
    color: #804000; /* 设置气泡文本的颜色 */
    padding: 2px;
    border-radius: 5px;
    max-width: 30%; /* 设置气泡的最大宽度 */
    margin-top: -75px;
