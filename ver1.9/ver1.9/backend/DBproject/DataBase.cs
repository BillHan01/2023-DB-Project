...
namespace DBproject
{
    public class DataBase
    {
        ...
        /*搜索特定ID客户的浏览记录*/
        public List<CommodityListModel> sqlSearchBrowseHistory(GetBrowsingHistoryModel model)
        {
            DateTime date = DateTime.Now;
            Console.WriteLine($"current time =>{date}");
            var list = new List<CommodityListModel>();
            ...
            //AND COMMODITY.COM_NAME LIKE '%{model.search_str}%'
        ...
        private static string SanitizeCommentWithSensitiveWordsFromFile(string comment)
        {
