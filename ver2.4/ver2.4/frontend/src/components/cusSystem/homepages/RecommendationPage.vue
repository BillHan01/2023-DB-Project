            ...
            <Waterfall :list="List" v-bind="options" >
                <template #item="{ item  }" >
                    <div  class="cardset" >
                        ...
                        <div>
                            <el-row justify="center" @click="handleClickList(item)"> 
                            ...
                            <el-row justify="space-around">
                                <el-col :span="10">
                                <el-text style="text-decoration:line-through;font-size: medium;" >¥ {{ item.com_oriPrice }}</el-text>
                                </el-col>
                                <el-col :span="10" >
                                    
                                    <el-text style="color: rgb(254, 7, 7);font-size: larger; ">¥ {{ item.com_price }}</el-text >
                            ...
                            <el-row justify="space-around" style="margin-top: 10px;">
                                <el-col :span="14" :offset="2">
                                    <el-text :style="{ color: item.com_color }" style="">
                                    距离过期还有{{ item.dayDiff }}天 
                                    </el-text>
                                </el-col>
                                <el-col :span="4">
                                    <el-text v-if="item.com_status==0" style="color:red;">售罄</el-text>
                                </el-col>
                                <el-col :span="4" :pull="1" style="display: flex;justify-content: center;align-items: center;padding-bottom: 4px;">
...
import { ref, reactive, onMounted,computed, watchEffect,onDeactivated} from 'vue';
