<template>
    <el-container>
      <el-header style="background-color: #337ecc;">
        <el-row justify="space-between">
          ...
          <el-col :span="16" style="display: flex;justify-content: space-around;align-items: center;">
            <el-link :icon="Present" @click="recommendationNav" style="color: aliceblue;font-size: large;">推荐</el-link>
    ...
    //axios.defaults.baseURL = 'http://124.70.7.210:5000';//网址基址
