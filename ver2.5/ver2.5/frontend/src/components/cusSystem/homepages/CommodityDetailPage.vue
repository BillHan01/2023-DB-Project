            ...
            <el-card class="box-card">
              <div v-if="!isExpired" class="button-group">
                ...
                <div class="right-buttons">
                  ...
                  <el-button type="info" @click="complain_com">投诉</el-button>
                </div>
              </div>
            </el-card>
...
<el-dialog
  ...
  <div>
    ...
    <el-text>
      当前余额：{{ balance }}
      <br>
      本次购买将消费：{{ quantity}} * {{ present_price }} = {{quantity * present_price}}元
      <br>
      消费后剩余：<el-text :type="balance - quantity * present_price<0?'danger':'success'">{{  balance - quantity * present_price }}元 </el-text>
    </el-text>
  </div>  
  <template v-slot:footer>
...
<el-dialog
  ...
  <el-upload
    ...
    >
      <el-button type="primary">点击上传申诉截图</el-button>
    </el-upload>
     <!-- 图片预览 -->
