  ...
  <el-card>
    ...
    <el-row :gutter="20">
      ...
      <el-card>
        {{ "申诉ID : "+item.APP_ID }}
        <el-row :gutter="20" >
            <el-col :span="5" v-for="(itemm,idx) in item.SCT_IMAGE" :key="idx"><el-image style="width: 100px; height: 100px" :src="itemm" fit="fill" /></el-col>
      ...
      >
          ...
          <el-tag size="small">{{item.APP_MATTERS}}</el-tag>
          </el-descriptions-item>
